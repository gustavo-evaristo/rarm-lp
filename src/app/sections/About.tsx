...
export function About() {
  return (
    <section className="flex flex-col gap-3 items-start justify-start mt-44 px-32">
      <h4 className="font-bold text-primary-pure text-2xl">
        Por que escolher a RARM
      </h4>

      <h3 className="text-4xl text-low-pure font-semibold">
        Sua empresa em boas mãos
      </h3>

      <p className="text-xl/[26px] text-low-pure max-w-[641px] font-medium">
